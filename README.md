...
- **[🗂️ STRUCTURE](docs/STRUCTURE.md)** - Complete directory structure
- **[💻 Developer Guide](docs/copilot-instructions.md)** - Development guidelines and contribution rules

### Bash Configuration Documentation

- **[Bash Docs Overview](docs/bash/docs/README.md)** - Complete bash module documentation
- **[Configuration Guide](docs/bash/docs/config.md)** - Installation and configuration
- **[Aliases System](docs/bash/docs/aliases.md)** - How aliases work
- **[Shell Completion](docs/bash/docs/completion.md)** - Autocomplete setup
- **[Core Modules](docs/bash/docs/core.md)** - Logger, colors, spinner modules
- **[Functions Library](docs/bash/docs/functions.md)** - Available functions
- **[Integrations](docs/bash/docs/integrations.md)** - External tool integration
- **[Themes](docs/bash/docs/themes.md)** - Theme customization
- **[Testing Guide](docs/bash/docs/tests.md)** - Running tests

### Function Reference

- [Aliases Functions](docs/bash/functions/aliases.md)
- [Development Functions](docs/bash/functions/development.md)
- [Docker Functions](docs/bash/functions/docker.md)
- [Filesystem Functions](docs/bash/functions/filesystem.md)
- [Music Functions](docs/bash/functions/music.md)
