...
# Note: This script serves as a reference/documentation for how vim configs are organized
# The actual sourcing happens in ~/.vimrc which calls SourceConfigDir() functions
